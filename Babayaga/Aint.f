...
c      parameter (nmax=10,npmax=900)
      parameter (nmax=18,npmax=900)
      integer nlb
      parameter (nlb=4)            
...
C     
      integer nmax
c      parameter (nmax=10)       !maximum number of external particles. 
      parameter (nmax=18)       !maximum number of external particles. 
