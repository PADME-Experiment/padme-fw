...
# Define path to PadmeGeom and add it to LD_LIBRARY_PATH
export PADMEGEOM=${PADME}/PadmeGeom
...
export LD_LIBRARY_PATH="${clean_ld_library_path}:${PADMEROOT}/lib:${PADMEGEOM}/lib"
