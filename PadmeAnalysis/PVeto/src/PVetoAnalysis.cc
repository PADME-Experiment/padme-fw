...
Bool_t PVetoAnalysis::InitHistosValidation()
{
  ...
  hname="PVeto_HitZPos";
  hSvcVal->BookHisto(hname, nBin, min, max);
  hname="PVeto_ClusterZPos";
  hSvcVal->BookHisto(hname, nBin, min, max);
  nBin=100;
  min=0;
  max=100;
  hname="PVeto_HitChannelId";
  hSvcVal->BookHisto(hname, nBin, min, max);
  hname="PVeto_ClusterSeedChannelId";
  hSvcVal->BookHisto(hname, nBin, min, max);
  nBin=16;
  min=0;
  max=15;
  hname="PVeto_NHitInCluster";
  hSvcVal->BookHisto(hname, nBin, min, max);
