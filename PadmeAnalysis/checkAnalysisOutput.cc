...
void checkAnalysisOutput(){
  ...
  TFile *f = TFile::Open("240826_analysisForUpScaledCalib.root");
  TDirectory* dir = (TDirectory*) f->Get("ECalMLCalibration");
  TFile *outRoot = new TFile("run30369_UPCalib.root","RECREATE");
  ...
  coeffFile = fopen("run30369_UPCalibCoefficients.dat","w");
  constsFile = fopen("run30369_UPCalibConstants.dat","w");
