...
class PadmeCDRServer:
    ...
    def __init__(self,cfg_file,mode):
        ...
        #if (self.create_long_proxy_file() == "error"): exit(1)
    ...
    #def create_long_proxy_file(self):
    #    # Generate a 20days generic proxy
    #    for line in self.run_command("voms-proxy-init --valid 480:0 --out %s"%self.long_proxy_file):
    #        print(line.rstrip())
    #    return "ok"
    ...
    def renew_voms_proxy(self):
        ...
        if renew:
            ...
            for line in self.run_command("voms-proxy-init --noregen --cert %s --key %s --voms vo.padme.org --valid 96:0"%(self.long_proxy_file,self.long_proxy_file)):
                print(line.rstrip())
