...
//int db_process_close(int,time_t); // process_id,stop time
...
//int db_file_close(char*,time_t,unsigned long long int,unsigned int,int); // file_name,time,size,nevents,process_id
