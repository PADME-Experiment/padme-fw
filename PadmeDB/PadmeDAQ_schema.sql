...
-- -----------------------------------------------------
-- Table `PadmeDAQ`.`level1_process`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`level1_process` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `run_number` INT NOT NULL,
  `node_id` INT NOT NULL,
  `number` INT NULL,
  ...
  INDEX `fk_lvl1_process_node1_idx` (`node_id` ASC),
  UNIQUE INDEX `lvl1_run_and_number` (`run_number` ASC, `number` ASC),
  CONSTRAINT `fk_lvl1_process_run1`
    FOREIGN KEY (`run_number`)
    REFERENCES `PadmeDAQ`.`run` (`number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_lvl1_process_node1`
    FOREIGN KEY (`node_id`)
    REFERENCES `PadmeDAQ`.`node` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `PadmeDAQ`.`level1_proc_config_para`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`level1_proc_config_para` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `level1_process_id` INT NOT NULL,
  `config_para_name_id` INT NOT NULL,
  `value` VARCHAR(1024) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_lvl1_proc_config_para_config_para_name1_idx` (`config_para_name_id` ASC),
  INDEX `fk_lvl1_proc_config_para_lvl1_process1_idx` (`level1_process_id` ASC),
  ...
  CONSTRAINT `fk_lvl1_proc_config_para_lvl1_process1`
    FOREIGN KEY (`level1_process_id`)
    REFERENCES `PadmeDAQ`.`level1_process` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PadmeDAQ`.`merger_process`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`merger_process` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `run_number` INT NOT NULL,
  `node_id` INT NOT NULL,
  `status` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `PadmeDAQ`.`trigger_process`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`trigger_process` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `run_number` INT NOT NULL,
  `node_id` INT NOT NULL,
  `status` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `PadmeDAQ`.`trigger_proc_config_para`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`trigger_proc_config_para` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `trigger_process_id` INT NOT NULL,
  `config_para_name_id` INT NOT NULL,
  `value` VARCHAR(1024) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_daq_proc_config_para_config_para_name1_idx` (`config_para_name_id` ASC),
  INDEX `fk_trigger_proc_config_para_trigger_process1_idx` (`trigger_process_id` ASC),
  CONSTRAINT `fk_daq_proc_config_para_config_para_name1`
    FOREIGN KEY (`config_para_name_id`)
    REFERENCES `PadmeDAQ`.`config_para_name` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_trigger_proc_config_para_trigger_process1`
    FOREIGN KEY (`trigger_process_id`)
    REFERENCES `PadmeDAQ`.`trigger_process` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PadmeDAQ`.`merger_proc_config_para`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`merger_proc_config_para` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `merger_process_id` INT NOT NULL,
  `config_para_name_id` INT NOT NULL,
  `value` VARCHAR(1024) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_daq_proc_config_para_config_para_name1_idx` (`config_para_name_id` ASC),
  INDEX `fk_merger_proc_config_para_merger_process1_idx` (`merger_process_id` ASC),
  CONSTRAINT `fk_daq_proc_config_para_config_para_name1`
    FOREIGN KEY (`config_para_name_id`)
    REFERENCES `PadmeDAQ`.`config_para_name` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_merger_proc_config_para_merger_process1`
    FOREIGN KEY (`merger_process_id`)
    REFERENCES `PadmeDAQ`.`merger_process` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
