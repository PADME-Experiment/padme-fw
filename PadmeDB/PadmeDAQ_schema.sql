...
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`run_type` (
  ...
  UNIQUE INDEX `run_type_UNIQUE` (`type` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`config_para_name` (
  ...
  `description` TEXT NULL,
  UNIQUE INDEX `config_para_name_UNIQUE` (`name` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`process_type` (
  ...
  `description` TEXT NULL,
  UNIQUE INDEX `proc_type_UNIQUE` (`type` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`file_type` (
  ...
  `description` TEXT NULL,
  UNIQUE INDEX `file_type_UNIQUE` (`type` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `PadmeDAQ`.`run_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`run_status` (
  `id` INT NOT NULL,
  `status` VARCHAR(255) NOT NULL,
  `description` TEXT NULL,
  UNIQUE INDEX `run_status_UNIQUE` (`status` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `PadmeDAQ`.`process_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`process_status` (
  `id` INT NOT NULL,
  `status` VARCHAR(255) NOT NULL,
  `description` TEXT NULL,
  UNIQUE INDEX `proc_status_UNIQUE` (`status` ASC),
  PRIMARY KEY (`id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `PadmeDAQ`.`det_board`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`det_board` (
  `id` INT NOT NULL,
  `detector` VARCHAR(255) NOT NULL,
  `idx` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `detector_index_UNIQUE` (`detector` ASC, `idx` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `PadmeDAQ`.`l_det_board_optical_link`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PadmeDAQ`.`l_det_board_optical_link` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `det_board_id` INT NOT NULL,
  `optical_link_id` INT NOT NULL,
  `time_start` DATETIME NULL,
  `time_stop` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_l_det_board_optical_link_optical_link1_idx` (`optical_link_id` ASC),
  INDEX `fk_l_det_board_optical_link_det_board1_idx` (`det_board_id` ASC),
  CONSTRAINT `fk_l_det_board_optical_link_optical_link1`
    FOREIGN KEY (`optical_link_id`)
    REFERENCES `PadmeDAQ`.`optical_link` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_l_det_board_optical_link_det_board1`
    FOREIGN KEY (`det_board_id`)
    REFERENCES `PadmeDAQ`.`det_board` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
