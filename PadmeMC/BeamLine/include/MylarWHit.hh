...
public:
  ...
  MylarWHit();
  ~MylarWHit();
  MylarWHit(const MylarWHit&);
  const MylarWHit& operator=(const MylarWHit&);
  G4int operator==(const MylarWHit&) const;
...
typedef G4THitsCollection<MylarWHit> MylarWHitsCollection;

extern G4Allocator<MylarWHit> MylarWHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void* MylarWHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) MylarWHitAllocator.MallocSingle();
  return aHit;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void MylarWHit::operator delete(void *aHit)
{
  MylarWHitAllocator.FreeSingle((MylarWHit*) aHit);
}
