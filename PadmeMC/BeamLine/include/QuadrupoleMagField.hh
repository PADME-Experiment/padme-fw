...
//
//
// $Id: QuadrupoleMagField.hh 69786 2013-05-15 09:38:51Z gcosmo $
//
//
...
// 11.5.12 - B. Riese allow displaced origin and rotation (Bj̦rn Riese)
// -------------------------------------------------------------------
...
class QuadrupoleMagField : public G4MagneticField
{
  public: // with description

    QuadrupoleMagField(G4double          pGradient);
    QuadrupoleMagField(G4double          pGradient, 
