...
void MMegaDetector::CreateGeometry()
{
  ...
  G4double MMegaFaradayPanelSizeX = geo->GetMMegaFaradayPanelSizeX();
  G4double MMegaFaradayPanelSizeY = geo->GetMMegaFaradayPanelSizeY();
  ...
  G4double MMegaFR4SizeZ = geo->GetMMegaFR4SizeZ();
  ...
  G4LogicalVolume* fMMegaFaradayFR4Volume = new G4LogicalVolume(solidFaradayFR4Volume, G4Material::GetMaterial("PCB"), "FaradayFR4Volume", 0,0,0);
  fMMegaFaradayFR4Volume->SetVisAttributes(G4VisAttributes(G4Colour::Green()));

  G4double MMegaFaradayCopperSizeZ = geo->GetMMegaFaradayCopperSizeZ();
  G4Box* solidFaradayCopperVolume = new G4Box("solidFaradayCopperVolume", 0.5*MMegaFaradayPanelSizeX, 0.5*MMegaFaradayPanelSizeY, 0.5*MMegaFaradayCopperSizeZ);
  G4LogicalVolume* fMMegaFaradayCopperVolume = new G4LogicalVolume(solidFaradayCopperVolume, G4Material::GetMaterial("PCB"), "FaradayCopperVolume", 0,0,0);
  fMMegaFaradayCopperVolume->SetVisAttributes(G4VisAttributes(G4Colour::Green()));
  ...
  G4double MMegaFR4ReadoutSizeZ = geo->GetMMegaFR4ReadoutSizeZ();
  G4Box* solidFR4ReadoutVolume = new G4Box("solidFR4ReadoutVolume", 0.5*MMegaPanelSizeX, 0.5*MMegaPanelSizeY, 0.5*MMegaFR4ReadoutSizeZ);
  G4LogicalVolume* fMMegaFR4ReadoutVolume = new G4LogicalVolume(solidFR4ReadoutVolume, G4Material::GetMaterial("PCB"), "FR4ReadoutVolume",0,0,0);
  fMMegaFR4ReadoutVolume->SetVisAttributes(G4VisAttributes(G4Colour::Green()));
  ...
  FR4Pos2 = CopperPos1 + G4ThreeVector(0,0,0.5*(MMegaCopperSizeZ+MMegaFR4SizeZ+MMegaLayerGap));
  new G4PVPlacement(0,FR4Pos2, fMMegaFR4Volume, "FR4Layer2", fMMegaVolume, false,1,false);
  NomexPos = FR4Pos2 + G4ThreeVector(0,0,0.5*(MMegaFR4SizeZ+MMegaNomexSizeZ+MMegaLayerGap));
  new G4PVPlacement(0,NomexPos, fMMegaNomexVolume, "NomexLayer", fMMegaVolume, false,1,false);
  FR4Pos1 = NomexPos + G4ThreeVector(0,0,0.5*(MMegaNomexSizeZ+MMegaFR4SizeZ+MMegaLayerGap));
  new G4PVPlacement(0,FR4Pos1, fMMegaFR4Volume, "FR4Layer1", fMMegaVolume, false,1,false);
  // ShieldPos = FR4Pos1 + G4ThreeVector(0,0,0.5*(MMegaFR4SizeZ + MMegaCopperSizeZ+MMegaLayerGap));
  // new G4PVPlacement(0, ShieldPos, fMMegaCopperVolume, "CopperShield", fMMegaVolume,false,1,false);
  
  FR4FaradayPos1 = FR4Pos1 + G4ThreeVector(0,0,0.5*(MMegaFR4SizeZ + MMegaFaradayFR4SizeZ+MMegaLayerGap));
  new G4PVPlacement(0, FR4FaradayPos1, fMMegaFaradayFR4Volume, "FaradayFR4", fMMegaVolume,false,0,false);
  CopperFaradayPos1 = FR4FaradayPos1 + G4ThreeVector(0,0,0.5*(MMegaFaradayFR4SizeZ + MMegaFaradayCopperSizeZ+MMegaLayerGap));
  new G4PVPlacement(0, CopperFaradayPos1, fMMegaFaradayCopperVolume, "FaradayCopper", fMMegaVolume,false,0,false);
  ...
  G4double inverse_sum = MMegaDriftSizeZ/(fDriftVolume->GetMaterial()->GetRadlen()) +
                        ...
                        4*MMegaFR4SizeZ/(fMMegaFR4Volume->GetMaterial()->GetRadlen()) + 
