...
public:
  ...
  // Set position along Y of PVeto internal face
  void SetPVetoInnerFacePosY(G4double y) { fPVetoInnerFacePosY = y; }
...
private:
  ...
  G4double fPVetoInnerFacePosY; // Position along Y axis of PVeto inner face
