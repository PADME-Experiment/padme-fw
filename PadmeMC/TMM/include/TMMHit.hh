...
public:
  ...
  ~TMMHit();
  TMMHit(const TMMHit&);
  const TMMHit& operator=(const TMMHit&);
  G4int operator==(const TMMHit&) const;
...
typedef G4THitsCollection<TMMHit> TMMHitsCollection;

extern G4Allocator<TMMHit> TMMHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void* TMMHit::operator new(size_t)
{
  void *aHit;
  aHit = (void *) TMMHitAllocator.MallocSingle();
  return aHit;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline void TMMHit::operator delete(void *aHit)
{
  TMMHitAllocator.FreeSingle((TMMHit*) aHit);
}
