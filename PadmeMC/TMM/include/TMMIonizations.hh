...
#ifndef TMMIonizations_h
#define TMMIonizations_h 1
...
class TMMIonizations 
{
    public:

    TMMIonizations(G4ThreeVector start, G4ThreeVector end, G4double dE);
    ~TMMIonizations();
    ...
    G4double fIonizationEnergy = (0.88*15.7 + 0.10*16 + 0.02*10.6)*eV; //15.62eV
    
    G4double fWI    = (0.88*26 + 0.10*26 + 0.02*43.5) * eV;   //26.35eV       //Carrier cost (eV)
