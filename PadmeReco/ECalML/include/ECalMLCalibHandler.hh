#ifndef ECalMLCalibHandler_h
#define ECalMLCalibHandler_h
...
class ECalMLCalibHandler {

public :

  static ECalMLCalibHandler* GetInstance();
  ~ECalMLCalibHandler();

private:

  static ECalMLCalibHandler* fInstance;
