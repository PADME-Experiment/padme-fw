...
ECalMLClusterFinderRadius::ECalMLClusterFinderRadius(ECalMLCrystalHandler* cryH,ECalMLClusterHandler* cluH)
{
  ...
  // Get size of crystals from ECalMLParameters
...
ECalMLClusterFinderRadius::~ECalMLClusterFinderRadius()
{;}

Int_t ECalMLClusterFinderRadius::FindClusters()
{
...
void ECalMLClusterFinderRadius::ExpandCluster(ECalMLCluster* clu,ECalMLCrystal* cry)
{
  ...
  for(Int_t in=0;in<fNNeighbor;in++){
    ...
    ECalMLCrystal* cry_nbr = fCrystalHandler->GetCrystal(cx+fXNeighbor[in],cy+fYNeighbor[in]);
...
void ECalMLClusterFinderRadius::SetRadius(Double_t radius)
{
...
void ECalMLClusterFinderRadius::PrintNeighborMap()
{
