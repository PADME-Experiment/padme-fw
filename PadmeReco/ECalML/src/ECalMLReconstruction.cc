...
#include "ECalMLClusterFinderRadius.hh"
...
ECalMLReconstruction::ECalMLReconstruction(TFile* HistoFile, TString ConfigFileName)
  : PadmeVReconstruction(HistoFile, "ECalML", ConfigFileName)
{
  ...
  fReproductSACbunchStructure = (Int_t)fConfig->GetParOrDefault("RECO", "BunchStructureSAC_runJuly", 0);
    ...
    fChannelReco = new DigitizerChannelECalML();
    
    fClusterization = new ECalMLSimpleClusterization();
    fGeometry = new ECalMLGeometry(); 
    
    fChannelCalibration = new ECalMLCalibration();


}


void ECalMLReconstruction::HistoInit(){
  AddHisto("ECalMlECalMLOccupancy",new TH2F("ECalMLECalMLOccupancy","ECalMLOccupancy",31,0,31,31,0,31));
  AddHisto("ECalMlECalMLOccupancyOffTime",new TH2F("ECalMLECalMLOccupancyOffTime","ECalMLOccupancyOffTime",31,0,31,31,0,31));
  AddHisto("ECalMlECalMLEvent",new TH2F("ECalMLECalMLEvent","ECalMLEvent",31,0,31,31,0,31));
  AddHisto("ECalMlECalMLChEvent",new TH2F("ECalMLECalMLChEvent","ECalMLChEvent",31,0,31,31,0,31));
  AddHisto("ECalMlECalMLCharge",new TH2F("ECalMLECalMLCharge","ECalMLCharge",31,0,31,31,0,31));
  //  AddHisto("ECalMlECalMLTotCharge",new TH1F("ECalMLECalMLTotCharge","ECalMLTotCharge",1001,0,100));
  AddHisto("ECalMlECalMLChCharge",new TH1F("ECalMLECalMLChCharge","ECalMLChCharge",1001,0,100));
  //  AddHisto("ECalMlECalMLTime",new TH1F("ECalMLECalMLTime","ECalMLTime",1000,-200,800));

  AddHisto("ECalMlECALClPos",new TH2F("ECalMLECALClPos","ECALClPos",30,-15,15,30,-15,15));
  AddHisto("ECalMlECALCellPos",new TH2F("ECalMLECALCellPos","ECALCellPos",30,0,30,30,0,30));
  //  AddHisto("ECalMlECALVoters",new TH2F("ECalMLECALVoters","ECALVoters",1000,0.,1000.,26,-0.5,25.5));

  //AddHisto("ECalMlECALTime",new TH1F("ECalMLECALTime","ECALTime",2000,-200,800));
  AddHisto("ECalMlECALTime",new TH1F("ECalMLECALTime","ECALTime",400,-150,250));
  AddHisto("ECalMlECALTimeCut",new TH1F("ECalMLECALTimeCut","ECALTimeCut",500,0,800));
  AddHisto("ECalMlECALClTime",new TH1F("ECalMLECALClTime","ECALClTime",500,-200,800));
  AddHisto("ECalMlECALClTimeCut",new TH1F("ECalMLECALClTimeCut","ECALClTimeCut",500,-200,800));
  AddHisto("ECalMlECALETot",new TH1F("ECalMLECALETot","ECALETot",500,0,2500));
  AddHisto("ECalMlECALQTot",new TH1F("ECalMLECALQTot","ECALQTot",500,0,2500));
  AddHisto("ECalMlECALNPart",new TH1F("ECalMLECALNPart","ECALNPart",200,0,200));
  AddHisto("ECalMlECALNClus",new TH1F("ECalMLECALNClus","ECALNClus",200,0,200));

  AddHisto("ECalMlECALDropHitE",new TH1F("ECalMLECALDropHitE","ECALDropHitE",500,0,500));
  AddHisto("ECalMlECALHitE",new TH1F("ECalMLECALHitE","ECALHitE",550,0,550));

  //  AddHisto("ECalMlECALRawClus",new TH1F("ECalMLECALRawClus","ECALRawClus",200,0,1000));
  AddHisto("ECalMlECALClE",new TH1F("ECalMLECALClE","ECALClE",500,0,1000));

  AddHisto("ECalMlECALClNCry",new TH1F("ECalMLECALClNCry","ECALClNCry",30,0,30));
  AddHisto("ECalMlECALClTDiff",new TH1F("ECalMLECALClTDiff","ECALClTDiff",100,-10,10));

  AddHisto("ECalMlECALClSeed",new TH1F("ECalMLECALClSeed","ECALClSeed",3000,0,3000));
  AddHisto("ECalMlECALClSeedEn",new TH1F("ECalMLECALClSeedEn","ECALClSeedEn",550,0,550));
  AddHisto("ECalMlECALNeig",new TH1F("ECalMLECALNeig","ECALNeig",9,-4.5,4.5));

  //histograms to debug mc wave IO
  AddHisto("ECalMlnDigiForCh",new TH1F("ECalMLnDigiForCh","nDigiForCh",20,0,20));
  AddHisto("ECalMlnDigiForCh_1RecoHit", new TH1F("ECalMLnDigiForCh_1RecoHi","nDigiForCh_1RecoHi",11, -0.5, 10.5));
  AddHisto("ECalMlDEnergy_digiTemplate", new TH1F("ECalMLDEnergy_digiTemplate","DEnergy_digiTemplate",400, -200, 200));
  AddHisto("ECalMlDEnergy_1RecoHit", new TH1F("ECalMLDEnergy_1RecoHit","DEnergy_1RecoHit",400, -200, 200));
  AddHisto("ECalMlDEnergy_1RecoHit1ndigi", new TH1F("ECalMLDEnergy_1RecoHit1ndigi","DEnergy_1RecoHit1ndigi",400, -200, 200));

  AddHisto("ECalMlDEnergy_1RecoSaturatedHit", new TH1F("ECalMLDEnergy_1RecoSaturatedHit","DEnergy_1RecoSaturatedHit",400, -200, 200));
  AddHisto("ECalMlDEnergy_1RecoSaturatedHit1ndigi", new TH1F("ECalMLDEnergy_1RecoSaturatedHit1ndigi","DEnergy_1RecoSaturatedHit1ndigi",400, -200, 200));
  AddHisto("ECalMlDEnergy_1RecoNoSaturatedHit", new TH1F("ECalMLDEnergy_1RecoNoSaturatedHit","DEnergy_1RecoNoSaturatedHit",400, -200, 200));
  AddHisto("ECalMlDEnergy_1RecoNoSaturatedHit1ndigi", new TH1F("ECalMLDEnergy_1RecoNoSaturatedHit1ndigi","DEnergy_1RecoNoSaturatedHit1ndigi",400, -200, 200));

  AddHisto("ECalMlDTime_1RecoSaturatedHit", new TH1F("ECalMLDTime_1RecoSaturatedHit","DTime_1RecoSaturatedHit",400, -200, 200));
  AddHisto("ECalMlDTime_1RecoSaturatedHit1ndigi", new TH1F("ECalMLDTime_1RecoSaturatedHit1ndigi","DTime_1RecoSaturatedHit1ndigi",400, -200, 200));
  AddHisto("ECalMlDTime_1RecoNoSaturatedHit", new TH1F("ECalMLDTime_1RecoNoSaturatedHit","DTime_1RecoNoSaturatedHit",400, -200, 200));
  AddHisto("ECalMlDTime_1RecoNoSaturatedHit1ndigi", new TH1F("ECalMLDTime_1RecoNoSaturatedHit1ndigi","DTime_1RecoNoSaturatedHit1ndigi",400, -200, 200));

  AddHisto("ECalMlDTime_1RecoHit", new TH1F("ECalMLDTime_1RecoHit","DTime_1RecoHit",400, -200, 200));
  AddHisto("ECalMlDTime_1RecoHit1ndigi", new TH1F("ECalMLDTime_1RecoHit1ndigi","DTime_1RecoHit1ndigi",400, -200, 200));
  // AddHisto("ECalMlDEnergy_1RecoSaturatedHit", new TH1F("ECalMLDEnergy_1RecoSaturatedHit","DEnergy_1RecoSaturatedHit",400, -1000, 1000));
  //AddHisto("ECalMlDTime_1RecoSaturatedHit", new TH1F("ECalMLDTime_1RecoSaturatedHit","DTime_1RecoSaturatedHit",400, -200, 200));

 AddHisto("ECalMlCorrNoNoiseAllInitialFromCalculation_1RecoHit_nosat_VMaxvsEnergy", new TH2F("ECalMLCorrNoNoiseAllInitialFromCalculation_1RecoHit_nosat_VMaxvsEnergy", "CorrNoNoiseAllInitialFromCalculation_1RecoHit_nosat_VMaxvsEnergy", 1000, 0., 1000.,1000.,0.,1000.));

 AddHisto("ECalMlECALHitTimeDistribution",new TH1F("ECalMLECALHitTimeDistribution","ECALHitTimeDistribution",700,-200,500));
 AddHisto("ECalMlECALHitTimeDistribution_bunch",new TH1F("ECalMLECALHitTimeDistribution_bunch","ECALHitTimeDistribution_bunch",700,-200,500));


  // new histograms from Venelin
  AddHisto("ECalMlECALCellPos",new TH2F("ECalMLECALCellPos0cut","ECALCellPos0cut",30,0,30,30,0,30));
  AddHisto("ECalMlECALTDiffCos",new TH1F("ECalMLECALTDiffCos","ECALTDiffCos",200,-20,20));
  AddHisto("ECalMlECALHitTDiff",new TH1F("ECalMLECALHitTDiff","ECALHitTDiff",1000,-125,125));
  AddHisto("ECalMlEtotInner",new TH1F("ECalMLEtotInner","EtotInner",550,-1000.,10000.));
  AddHisto("ECalMlEtotOuter",new TH1F("ECalMLEtotOuter","EtotOuter",550,-1000.,10000.));
  AddHisto("ECalMlEtotMiddle",new TH1F("ECalMLEtotMiddle","EtotMiddle",550,-1000.,10000.));
  AddHisto("ECalMlEtotCorner",new TH1F("ECalMLEtotCorner","EtotCorner",550,-1000.,10000.));
  AddHisto("ECalMlEtot",     new TH1F("ECalMLEtot","Etot",1200,-1000.,5000.));
...
ECalMLReconstruction::~ECalMLReconstruction()
{;}


/*
TRecoVEvent * ECalMLReconstruction::ProcessEvent(TDetectorVEvent* tEvent, Event* tGenEvent)
{
  //common part for all the subdetectors
  PadmeVReconstruction::ProcessEvent(tEvent, tGenEvent);

  TECalMLEvent* tECalMLEvent = (TECalMLEvent*)tEvent;
  const TClonesArray& Digis = (*(tECalMLEvent->GetHits()));
  return fRecoEvent;
}
*/


void ECalMLReconstruction::ProcessEvent(TRawEvent* rawEv){
  ...
  if(fChannelCalibration) ((ECalMLCalibration*)fChannelCalibration)->PerformCalibration(GetRecoHits(),rawEv);
...
bool ECalMLReconstruction::TriggerToBeSkipped()
{
...
void ECalMLReconstruction::BuildHits(TRawEvent* rawEv)
{
  ...
  ((DigitizerChannelECalML*)fChannelReco)->SetTrigMask(GetTriggerProcessor()->GetTrigMask());
  ...
  for(Int_t iBoard = 0; iBoard < nBoards; iBoard++) {
    ...
    for(unsigned ich = 0; ich < ADC->GetNADCChannels();ich++) {
      ...
      //printf("ECalMLReconstruction::BuildHits Board %d Channel %d ChID %d\n",iBdID,ElChID,ChID);
      if (ChID == -1) continue; // Skip channels not used by ECalML (e.g. LeadGlass and Cosmics)

      fChannelReco->SetDigis(chn->GetNSamples(),chn->GetSamplesArray());

      //Store info for the digitizer class
      ((DigitizerChannelECalML*)fChannelReco)->SetChID(ChID);
      ((DigitizerChannelECalML*)fChannelReco)->SetElChID(ElChID);
      ((DigitizerChannelECalML*)fChannelReco)->SetBdID(iBdID);
...
//void ECalMLReconstruction::ProcessEvent(TMCVEvent* tEvent, TMCEvent* tMCEvent)
void ECalMLReconstruction::BuildECalMLIslandRadiusClusters(Int_t type)
{
  /*
  if (type==3)std::cout<<"In BuildECalMLIslandClusters "<<std::endl;
  else if (type==4)std::cout<<"In BuildECalMLRadiusClusters "<<std::endl;
  */
  ...
  ECalMLCrystalHandler* cryHand = new ECalMLCrystalHandler();
  for (Int_t ih=0; ih<Hits.size(); ++ih) {
    ...
    Int_t iX = ch/100;
    Int_t iY = ch%100;
    ECalMLCrystal* cry = cryHand->CreateCrystal(iX,iY);
  ...
  ECalMLClusterHandler* cluHand = new ECalMLClusterHandler();
  ECalMLClusterFinderIsland* cluFindIsl=NULL;
  ECalMLClusterFinderRadius* cluFindRad=NULL;
  Int_t newNClu = 0;
  if       (type==3) {
    cluFindIsl = new ECalMLClusterFinderIsland(cryHand,cluHand);
    newNClu = cluFindIsl->FindClusters();
    //printf("- Cluster finding result - PadmeIsland algorithm -\n");
  }
  else if  (type==4) {
    cluFindRad = new ECalMLClusterFinderRadius(cryHand,cluHand);
  ...
  for (Int_t ic=0; ic<newNClu; ++ic) {
    ...
    ECalMLCluster* cl = cluHand->GetCluster(ic);
...
void ECalMLReconstruction::AnalyzeEvent(TRawEvent* rawEv){
  static int nevt;
  static TCanvas c;
  static int filled    = 0;
  vector<TRecoVHit *> &Hits  = GetRecoHits();
  ...
  // M. Raggi 22/11/2018 bulding ECalML clusters
  // ClNCry.clear();
  // ClTime.clear();
  // ClE.clear();
  // ClX.clear();
  ...
  int NClusters = myClus.size();//ECalMLBuildClusters(rawEv);

  //  GetHisto("ECalMLECALNPart")->Fill(ECALNPart);
  GetHisto("ECalMLECALNClus")->Fill(NClusters);
  //  GetHisto("ECalMLECALETot") ->Fill(EvTotE);


  for(int gg=0;gg<NClusters;gg++){
    GetHisto("ECalMLECALClE")->Fill( myClus[gg]->GetEnergy() );
    GetHisto("ECalMLECALClNCry")->Fill( myClus[gg]->GetNHitsInClus() );
    GetHisto("ECalMLECALClTime")->Fill( myClus[gg]->GetTime() );
    if(myClus[gg]->GetNHitsInClus()>1 &&  myClus[gg]->GetEnergy()>50.) {
      GetHisto("ECalMLECALClTimeCut")->Fill( myClus[gg]->GetTime() );
    }
  }
  ...
  for(unsigned int iHit1 =  0; iHit1 < Hits.size(); ++iHit1) {
    ...
    GetHisto("ECalMLECalMLOccupancy") -> Fill(ich/100,ich%100);

    ((TH2F *) GetHisto("ECalMLECalMLCharge")) -> Fill(ich/100,ich%100,Hits[iHit1]->GetEnergy());
    (GetHisto("ECalMLECalMLChCharge")) -> Fill(Hits[iHit1]->GetEnergy());
    ...
    carica = GetHisto("ECalMLECalMLOccupancyOffTime") -> GetBinContent(ix,iy);
    newcarica = (carica*nevt+Hits[iHit1]->GetEnergy())/nnn;
    GetHisto("ECalMLECalMLOccupancyOffTime") -> SetBinContent(ix,iy,newcarica);
    double tempo = Hits[iHit1]->GetTime();

    //    std::cout << "ECalML time:  "<< tempo << "  "  << ich << std::endl;
    ((TH1F *) GetHisto("ECalMLECALTime")) -> Fill(tempo);
  ...
  (GetHisto("ECalMLEtot")) -> Fill(summa);
  (GetHisto("ECalMLEtotInner")) -> Fill(Einner);
  (GetHisto("ECalMLEtotOuter")) -> Fill(Eouter);
  (GetHisto("ECalMLEtotCorner")) -> Fill(Ecorner);
  (GetHisto("ECalMLEtotMiddle")) -> Fill(Emiddle);

  //  ((TH1F *) GetHisto("ECalMLECalMLTotCharge")) -> Fill(summa);
  ...
  if (q1 > 25. && q3 > 25. && filled==0) {
    for(unsigned int iHit1 =  0; iHit1 < Hits.size(); ++iHit1) {
      int ich = Hits[iHit1]->GetChannelId();
      GetHisto("ECalMLECalMLEvent")->SetBinContent(ich/100+1,ich%100+1, Hits[iHit1]->GetEnergy() );
      filled = 1;
    }
  }
  ...
  if (NHighEgamma>1&&(GetHisto("ECalMLECalMLChEvent"))->GetEntries()==0) {
    for(unsigned int iHit1 =  0; iHit1 < Hits.size(); ++iHit1) {
      int ich = Hits[iHit1]->GetChannelId();
      GetHisto("ECalMLECalMLChEvent")->SetBinContent(ich/100+1,ich%100+1, Hits[iHit1]->GetEnergy() );
    }
  }
  ...
  if(icl == 2) {    
    GetHisto("ECalMLEsum-2") ->Fill( ecl[0] + ecl[1]);
        
    if( xcl[0] < 10 && xcl[1] > 20  )   
      GetHisto("ECalMLEsum-2G") ->Fill(ecl[0] + ecl[1] ); 
...
Int_t ECalMLReconstruction::FindSeed(Int_t nele, Int_t * Used, Double_t* Ene) {
...
Int_t ECalMLReconstruction::IsSeedNeig(Int_t seedID, Int_t cellID) {
...
//  Written by M. Raggi 22/11/2018
void ECalMLReconstruction::BuildClusters()
{
  
  if      (fClusterizationAlgo==1) ECalMLReconstruction::BuildSimpleECalMLClusters();
    ...
    ECalMLReconstruction::BuildECalMLIslandRadiusClusters(fClusterizationAlgo);
  }
  return;
}
...
Double_t ECalMLReconstruction::CompensateMissingE(Double_t ECl, Int_t ClSeed)
{
 Double_t EFraction;
  Int_t ClusterSize=5;
  //  EFraction[490]=0.95;
...
void ECalMLReconstruction::BuildSimpleECalMLClusters()
{
  //std::cout<<"In BuildSimpleECalMLClusters "<<std::endl;
  vector<TRecoVCluster *> &myClusters  = GetClusters();
  for(unsigned int iCl = 0;iCl < myClusters.size();iCl++){
    delete myClusters[iCl];
  }
  ...
  if (Hits.size() > 3000) {
    std::cout << "ECalMLReconstruction::BuildSimpleEcalClusters --- ERROR: Too many hits in the ECalML (> 3000) ! Returning witout clustering..." << std::endl;
    return;
  }
  ...
  for(unsigned int iHit1 =  0; iHit1 < Hits.size(); ++iHit1) {
    if (iHit1==3000) {
      std::cout<<"ECalMLReconstruction::BuildSimpleECalMLClusters--- WARNING: Too small buffers w.r.t. n. of hits in the event --- stip here"<<std::endl;
      break;
    }
  ...
  while(iMax>-1){
    ...
    GetHisto("ECalMLECALClSeed")->Fill(SdCell[NSeeds]);
    GetHisto("ECalMLECALClSeedEn")->Fill(SdEn[NSeeds]);
	...
	{
	  if (NCry == NMaxHitsInCl) std::cout<<"INFO: ECalMLReconstruction:: Maximum n. of Hits in this cluster reached ("<<NMaxHitsInCl<<"); go to next seed, if any"<<std::endl;
	  continue;
	}
	...
	((TH2F *)GetHisto("ECalMLECALCellPos"))->Fill(XCl,YCl,cEnergy[iHit1]);
	cUsed[iHit1]=1;
	...
	if(SdCell[NSeeds]!=cChID[iHit1] && cEnergy[iHit1]>10.) GetHisto("ECalMLECALHitTDiff")->Fill( (cTime[iHit1]-SdTime[NSeeds]) );
	NCry++;
	HitUsed++;
    ...
    //GetHisto("ECalMLECALClE")->Fill(ClE[NSeeds]);
    ...
    GetHisto("ECalMLECALClTDiff")->Fill(ClTime[NSeeds]-SdTime[NSeeds]);
    ...
    if (NSeeds==NMaxCl) 
      {
	std::cout<<"INFO: ECalMLReconstruction:: Maximum n. of clusters reached ("<<NMaxCl<<"); stop the search here"<<std::endl;
	iMax = -1;
      }
  ...
  for(unsigned int iHit1 =  0; iHit1 < Hits.size(); ++iHit1) {
    //	 ECALDropHitE
    GetHisto("ECalMLECALHitE")->Fill(cEnergy[iHit1]);
    if(cUsed[iHit1]==0){
      GetHisto("ECalMLECALDropHitE")->Fill(cEnergy[iHit1]);
    }
  }
  return;// NGoodClus;
}

void ECalMLReconstruction::ConvertMCDigitsToRecoHitsWave(TMCVEvent* tEvent,TMCEvent* tMCEvent) {
 ...
 int idarray[50][50];
  ...
  for (Int_t i=0; i<tEvent->GetNDigi(); ++i) {
    GetHisto("ECalMLECALHitTimeDistribution")->Fill((tEvent->Digi(i))->GetTime());
  }
 ...
 if(fReproductSACbunchStructure){
   Double_t shiftTime=350;
	...
	double ys = fComulativeMax*(ydc-minTime)/width;*/
      ...
      GetHisto("ECalMLECALHitTimeDistribution_bunch")->Fill(xs+shiftTime);
    }
  }
  ...
  for (Int_t i=0; i<tEvent->GetNDigi(); ++i) {
    ...
    idarray[i1][i2]=1;
    GetHisto("ECalMLnDigiForCh")->Fill(ndigi);
    ...
    for(int j=0; j<hitArrayInCrystal.size(); j++){
      ...
      GetHisto("ECalMLCorrNoNoiseAllInitialFromCalculation_1RecoHit_nosat_VMaxvsEnergy")->Fill(energy_, vMaxMC);
	...
	GetHisto("ECalMLDEnergy_digiTemplate")->Fill(energy_-tempEnergy);
      }
      /////////////////////////////////////////////////////////////////
    ...
    ((DigitizerChannelECalML*)fChannelReco)->SetChID(chIdN);
    //std::cout<<"I've setted chId "<< ((DigitizerChannelECalML*)fChannelReco)->GetChID() <<std::endl;
    unsigned int nHitsBefore = Hits.size();
    fChannelReco->Reconstruct(Hits);
    unsigned int nHitsAfter = Hits.size();
    ...
    if(nHitsAfter-nHitsBefore==1){
	 ...
	 for (unsigned int i2 =  1; i2 < hitArrayInCrystal.size(); ++i2)
       ...
       GetHisto("ECalMLDEnergy_1RecoHit")->Fill(energy-Hits.at(nHitsAfter-1)->GetEnergy());
       GetHisto("ECalMLDTime_1RecoHit")->Fill(thitemax-Hits.at(nHitsAfter-1)->GetTime());
       if(saturated){
	 GetHisto("ECalMLDEnergy_1RecoSaturatedHit")->Fill(energy-Hits.at(nHitsAfter-1)->GetEnergy());
	 GetHisto("ECalMLDTime_1RecoSaturatedHit")->Fill(thitemax-Hits.at(nHitsAfter-1)->GetTime());
       }
       else{
	 GetHisto("ECalMLDEnergy_1RecoNoSaturatedHit")->Fill(energy-Hits.at(nHitsAfter-1)->GetEnergy());
	 GetHisto("ECalMLDTime_1RecoNoSaturatedHit")->Fill(thitemax-Hits.at(nHitsAfter-1)->GetTime());
       }
       if(ndigi==1){
	 GetHisto("ECalMLDEnergy_1RecoHit1ndigi")->Fill(energy-Hits.at(nHitsAfter-1)->GetEnergy());
	 GetHisto("ECalMLDTime_1RecoHit1ndigi")->Fill(thitemax-Hits.at(nHitsAfter-1)->GetTime());
	 if(saturated){
	   GetHisto("ECalMLDEnergy_1RecoSaturatedHit1ndigi")->Fill(energy-Hits.at(nHitsAfter-1)->GetEnergy());
	   GetHisto("ECalMLDTime_1RecoSaturatedHit1ndigi")->Fill(thitemax-Hits.at(nHitsAfter-1)->GetTime());
	 }
	 else{
	   GetHisto("ECalMLDEnergy_1RecoNoSaturatedHit1ndigi")->Fill(energy-Hits.at(nHitsAfter-1)->GetEnergy());
	   GetHisto("ECalMLDTime_1RecoNoSaturatedHit1ndigi")->Fill(thitemax-Hits.at(nHitsAfter-1)->GetTime());
	 }
       }
...
Bool_t ECalMLReconstruction::SimulateBrokenSU(Int_t x, Int_t y){
  Bool_t BrSU=false;
...
Double_t ECalMLReconstruction::EnergyResolution(Double_t energy){
  Double_t a=0.02;
  Double_t b=0.00003;
  Double_t c=0.012;
...
void ECalMLReconstruction::ConvertMCDigitsToRecoHits(TMCVEvent* tEvent,TMCEvent* tMCEvent) {
  ...
  if(fReproductSACbunchStructure){
	...
	double ys = fComulativeMax*(ydc-minTime)/width;*/
      ...
      if( xs <-45. )std::cout<<"old time " << digiTime<<" ys " << ys << " isbin " << isbin << " new Time " << xs << std::endl;
      digi->SetTime(xs);
      GetHisto("ECalMLECALHitTimeDistribution_bunch")->Fill(xs);
    }
  }
  ...
  if (fMultihitForMC==1) {
    ...
    for (Int_t i=0; i<tEvent->GetNDigi(); ++i) {
      ...
      // @reconstruction level, the ECalML ChIds are XXYY, while in MC they are YYXX 
      int chIdN = i2*100+i1;
      Hit->SetChannelId(chIdN);
      Hit->SetPosition(TVector3(0.,0.,0.)); 
      ...
      fHits.push_back(Hit);
      GetHisto("ECalMLECALHitTimeDistribution")->Fill(digi->GetTime());
    }
    return;
  }
	...
	for (Int_t dincr=1; dincr<maxLoop; ++dincr)
	  {
	    ...
	    GetHisto("ECalMLECALHitTimeDistribution")->Fill(hitArrayInCrystal[dincr].digiTime);
...
Double_t ECalMLReconstruction::compute_rms(Short_t* samples) {
  Double_t sum = 0.;
  Double_t sum2 = 0.;
