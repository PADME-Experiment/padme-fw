...
void DigitizerChannelEVeto::Init(GlobalRecoConfigOptions *gMode, PadmeVRecoConfig *cfg){
  ...
  fTimeCalibration  = cfg->GetParOrDefault("TimeCalibration", "CalibrationFile", 1); 
