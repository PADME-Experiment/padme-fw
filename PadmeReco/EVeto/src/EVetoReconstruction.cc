...
void EVetoReconstruction::HistoInit(){
  ...
  AddHisto("EVetoTime",new TH1F("EVetoTime","EVeto Time",1000,0.0,1000.0));
  AddHisto("EVetoTimeVsChannelID",new TH2F("EVetoTimeVsChannelID","EVeto Time vs Ch. ID",100,0,100,100,0.0,1000.0));
  AddHisto("EVetoHitTimeDifference",new TH1F("EVetoHitTimeDifference","Difference in time",400,-100.,100.));
  AddHisto("EVetoTimeVsEVetoTime",new TH2F("EVetoTimeVsEVetoTime","EVeto Time vs EVetoTime",1000,0.0,1000.0, 1000,0.0,1000.0));
