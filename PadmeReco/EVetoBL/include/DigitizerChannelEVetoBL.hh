...
class DigitizerChannelEVetoBL : public ChannelVReco {
public:

  DigitizerChannelEVetoBL(){;};
  virtual ~DigitizerChannelEVetoBL();
...
private:
  ...
  Double_t SetEVetoBLChaGain();
  Double_t SetEVetoBLT0();
