...
//
// --------------------------------------------------------------
#ifndef EVetoBLReconstruction_H
#define EVetoBLReconstruction_H
...
class EVetoBLReconstruction : public PadmeVReconstruction
{

public:
  
  EVetoBLReconstruction(TFile*, TString);
  ~EVetoBLReconstruction();
...
private:
  ...
  Double_t  fEVetoBLDigiTimeWindow;
