...
void LeadGlass2RecoRootIO::SaveEvent()
{
  ...
  if (fLGReco->LeadGlass2Found()) {
    ...
    ((TLeadGlass2RecoEvent*)fEvent)->SetPedestalV2(fLGReco->GetPedestalV2(1));
    ((TLeadGlass2RecoEvent*)fEvent)->SetPedestalRMSV2(fLGReco->GetPedestalRMSV2(1));
    ...
    ((TLeadGlass2RecoEvent*)fEvent)->SetTotalChargeV2(fLGReco->GetChargeV2(1));
    ((TLeadGlass2RecoEvent*)fEvent)->SetTotalChargeWPed(fLGReco->GetChargeWPed(1));
