...
void DigitizerChannelPVeto::PrepareDebugHistos(){ //Beth 20/10/21 copied from 190917padme-fw, in turn copied from Mauro's DigitizerChannelECal structure to create a set of debug histograms that are produced only in debug mode
  ...
  hDerivV                     = new TH1F("DerivV","DerivV",201,-0.5,400.5);
  hDerivVChannels20to70       = new TH1F("DerivVChannels20to70","DerivVChannels20to70",201,-0.5,400.5);
  hDerivVOneHit               = new TH1F("DerivVOneHit","DerivVOneHit",201,-0.5,400.5);
  hDerivVOneHitChannels20to70 = new TH1F("DerivVOneHitChannels20to70","DerivVOneHitChannels20to70",201,-0.5,400.5);
  hDerivVCorrect              = new TH1F("DerivVCorrect","DerivVCorrect",201,-0.5,400.5);
  hDerivVCorrectChannels20to70= new TH1F("DerivVCorrectChannels20to70","DerivVCorrectChannels20to70",201,-0.5,400.5);
  hHitTime                    = new TH1F("HitTime","HitTime",201,-0.5,400.5);
