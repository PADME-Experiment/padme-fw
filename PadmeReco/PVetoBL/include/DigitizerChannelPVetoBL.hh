...
class DigitizerChannelPVetoBL : public ChannelVReco {
public:

  DigitizerChannelPVetoBL(){;};
  virtual ~DigitizerChannelPVetoBL();
...
private:
  ...
  Double_t SetPVetoBLChaGain();
  Double_t SetPVetoBLT0();
