...
void RecoTMM::WriteCalibrationGraphTxt(ofstream &out, TGraphErrors *g, int runID, TString view){
...
void RecoTMM::WriteCalibrationConstants(TString filename, int runID){
