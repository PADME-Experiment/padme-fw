...
#define R__DICTIONARY_FILENAME CalibTMMDict
...
namespace ROOT {
   static TClass *CalibTMM_Dictionary();
   static void CalibTMM_TClassManip(TClass*);
   static void delete_CalibTMM(void *p);
   static void deleteArray_CalibTMM(void *p);
   static void destruct_CalibTMM(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::CalibTMM*)
   {
      ::CalibTMM *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TIsAProxy(typeid(::CalibTMM));
      static ::ROOT::TGenericClassInfo 
         instance("CalibTMM", "CalibTMM.h", 81,
                  typeid(::CalibTMM), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &CalibTMM_Dictionary, isa_proxy, 4,
                  sizeof(::CalibTMM) );
      instance.SetDelete(&delete_CalibTMM);
      instance.SetDeleteArray(&deleteArray_CalibTMM);
      instance.SetDestructor(&destruct_CalibTMM);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::CalibTMM*)
   {
      return GenerateInitInstanceLocal(static_cast<::CalibTMM*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::CalibTMM*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *CalibTMM_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal(static_cast<const ::CalibTMM*>(nullptr))->GetClass();
      CalibTMM_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   ...
   static void delete_CalibTMM(void *p) {
      delete (static_cast<::CalibTMM*>(p));
   }
   static void deleteArray_CalibTMM(void *p) {
      delete [] (static_cast<::CalibTMM*>(p));
   }
   static void destruct_CalibTMM(void *p) {
      typedef ::CalibTMM current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::CalibTMM
...
namespace {
  void TriggerDictionaryInitialization_CalibTMMDict_Impl() {
...
#line 1 "CalibTMMDict dictionary forward declarations' payload"
...
class __attribute__((annotate("$clingAutoload$CalibTMM.h")))  CalibTMM;
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "CalibTMMDict dictionary payload"
...
"CalibTMM", payloadCode, "@",
nullptr
};
    static bool isInitialized = false;
    if (!isInitialized) {
      TROOT::RegisterModule("CalibTMMDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_CalibTMMDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_CalibTMMDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_CalibTMMDict() {
  TriggerDictionaryInitialization_CalibTMMDict_Impl();
}
