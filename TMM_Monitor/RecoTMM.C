...
SliceFitResult RecoTMM::RunFitSlicesY(TH2F *h2, TString tag){
  ...
  auto EnsureBlockHistograms = [&](int iblock) {
    for (int l = 0; l < TMMCH_N_Readout; l++) {
      while ((int)hBlockqmaxstrip[l].size() <= iblock) {
        ...
        hBlockqmaxstrip[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstripFull[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstrip_cal[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstripFull_cal[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstrip_cal3s[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstripFull_cal3s[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstrip_Overallcal[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstripFull_Overallcal[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstrip_Overallcal3s[l].back()->SetXTitle("x strip");
        ...
        hBlockqmaxstripFull_Overallcal3s[l].back()->SetXTitle("x strip");
        ...
        TGraphAttribute(g_BlockFitFullDiff[l].back(), Form("g_BlockFitFullDiff%s", tmm_tag[l].Data()), "strip", "Q_{maxbin} - EvalFit [ADC counts]", 22, kBlack);
