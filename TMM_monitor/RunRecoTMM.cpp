...
void PrintUsage(const char* progname)
{
  ...
  cout << "  -b <N>        Block size in events. Default: 10000." << endl;
  cout << endl;
}
...
int main(int argc, char* argv[])
{
  ...
  // cout << "DEBUG main: before RecoTMM scope" << endl;
  {
    // cout << "DEBUG main: before RecoTMM construction" << endl;
    RecoTMM reco(&inputFileNameList, RunID, DetRunID, maxEvents, outputFileName);
    // cout << "DEBUG main: before LoopFileList" << endl;
    reco.LoopFileList(inputFileNameList, NevtBlock);    
    // cout << "DEBUG main: after LoopFileList" << endl;
  }

  // cout << "DEBUG main: after RecoTMM destructor" << endl;

  cout << endl;
  cout << "Done." << endl;
  // cout << "DEBUG main: before return 0" << endl;
