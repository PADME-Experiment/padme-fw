...
void ToyBBY_AA(double EBeam, int nEvent, array<TVector3,3> runconfig, double AngBeamDirX, double AngBeamDirY, const char* RootInput, const char* outputRoot)
{  
...
int main(int argc, char** argv) {
    ...
    cout << "##############Running ToyBBY_AA with parameters ##############" << endl;
    cout << "EBeam=" << EBeam << " MeV  nEvent=" << nEvent
         << " run=" << run << " thetaX=" << ThetaX << " thetaY=" << ThetaY << "\n"
         << "Input : " << inputRootFile << "\n"
         << "Output: " << outputRootFile << endl;

    ToyBBY_AA(EBeam, nEvent, runconfig, ThetaX, ThetaY, inputRootFile, outputRootFile);
