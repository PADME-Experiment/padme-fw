...
public:
  ...
  //getter for cuts
  inline Double_t GetTimeSafeMin() const { return fTimeSafeMin; };
  inline Double_t GetMaxTimeDistance() const { return fMaxTimeDistance; };
  inline Double_t GetMinGGDistance() const { return fMinGGDistance; };
  inline Double_t GetSafeEnergyFactor() const { return fSafeEnergyFactor; };
  inline Double_t GetSafeSpaceMargin() const { return fSafeSpaceMargin; };
  inline Double_t GetMeanDTheta() const { return fMeanDTheta; };
  inline Double_t GetMeanDPhi() const { return fMeanDPhi; };
  inline Double_t GetSigmaDTheta() const { return fSigmaDTheta; };
  inline Double_t GetSigmaDPhi() const { return fSigmaDPhi; };
  inline Double_t GetSigmaCut() const { return fSigmaCut; };
