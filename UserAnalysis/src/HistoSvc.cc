...
{ 
  ...
  fNtuple->Branch("NTTarget_Hits_ChannelId",&(myEvt.NTTarget_Hits_ChannelId),"NTTarget_Hits_ChannelId[NTNTarget_Hits]/D");
  ...
  fNtuple->Branch("NTPVeto_Hits_ChannelId",&(myEvt.NTPVeto_Hits_ChannelId), "NTPVeto_Hits_ChannelId[NTNPVeto_Hits]/D");
  ...
  fNtuple->Branch("NTPVeto_Clusters_ChannelId",  &(myEvt.NTPVeto_Clusters_ChannelId), "NTPVeto_Clusters_ChannelId[NTNPVeto_Clusters]/D");
  ...
  fNtuple->Branch("NTEVeto_Hits_ChannelId",&(myEvt.NTEVeto_Hits_ChannelId),"NTEVeto_Hits_ChannelId[NTNEVeto_Hits]/D");
  ...
  fNtuple->Branch("NTEVeto_Clusters_ChannelId",&(myEvt.NTEVeto_Clusters_ChannelId),   "NTEVeto_Clusters_ChannelId[NTNEVeto_Clusters]/D");
  ...
  fNtuple->Branch("NTHEPVeto_Hits_ChannelId",&(myEvt.NTHEPVeto_Hits_ChannelId),     "NTHEPVeto_Hits_ChannelId[NTNHEPVeto_Hits]/D");
  ...
  fNtuple->Branch("NTHEPVeto_Clusters_ChannelId",&(myEvt.NTHEPVeto_Clusters_ChannelId),        "NTHEPVeto_Clusters_ChannelId[NTNHEPVeto_Clusters]/D");
  ...
  fNtuple->Branch("NTECal_Hits_ChannelId",    &(myEvt.NTECal_Hits_ChannelId),     "NTECal_Hits_ChannelId[NTNECal_Hits]/D");
  ...
  fNtuple->Branch("NTECal_Clusters_ChannelId",&(myEvt.NTECal_Clusters_ChannelId),     "NTECal_Clusters_ChannelId[NTNECal_Clusters]/D");
  ...
  fNtuple->Branch("NTSAC_Hits_ChannelId",    &(myEvt.NTSAC_Hits_ChannelId),             "NTSAC_Hits_ChannelId[NTNSAC_Hits]/D");
  ...
  fNtuple->Branch("NTSAC_Clusters_ChannelId",  &(myEvt.NTSAC_Clusters_ChannelId),"NTSAC_Clusters_ChannelId[NTNSAC_Clusters]/D");
...
void HistoSvc::FillNtuple(PadmeAnalysisEvent* evt)
{
  ...
  for (Int_t i=0; i<nHits; ++i){
    ...
    myEvt.NTTarget_Hits_ChannelId[i]=(Double_t)hit->GetChannelId();
  ...
  for (Int_t i=0; i<nHits; ++i){
    ...
    myEvt.NTPVeto_Hits_ChannelId[i]=(Double_t)hit->GetChannelId();
  ...
  for (Int_t j=0; j<nClus; ++j){
    ...
    myEvt.NTPVeto_Clusters_ChannelId[j]=Double_t(clu->GetChannelId());
  ...
  for (Int_t i=0; i<nHits; ++i){
    ...
    myEvt.NTEVeto_Hits_ChannelId[i]=(Double_t)hit->GetChannelId();
  ...
  for (Int_t j=0; j<nClus; ++j){
    ...
    myEvt.NTEVeto_Clusters_ChannelId[j]=Double_t(clu->GetChannelId());
  ...
  for (Int_t i=0; i<nHits; ++i){
    ...
    myEvt.NTHEPVeto_Hits_ChannelId[i]=(Double_t)hit->GetChannelId();
  ...
  for (Int_t j=0; j<nClus; ++j){
    ...
    myEvt.NTHEPVeto_Clusters_ChannelId[j]=Double_t(clu->GetChannelId());
  ...
  for (Int_t i=0; i<nHits; ++i) {
    ...
    myEvt.NTECal_Hits_ChannelId[i]=(Double_t)hit->GetChannelId();
  ...
  for (Int_t j=0; j<nClus; ++j) {
    ...
    myEvt.NTECal_Clusters_ChannelId[j]=(Double_t)clu->GetChannelId();
  ...
  for (Int_t i=0; i<nHits; ++i){
    ...
    myEvt.NTSAC_Hits_ChannelId[i]=(Double_t)hit->GetChannelId();
  ...
  for (Int_t j=0; j<nClus; ++j){
    ...
    myEvt.NTSAC_Clusters_ChannelId[j]=(Double_t)clu->GetChannelId();
