...
void PADME_sensitivity(double TargetCalo, double E0, double EStep, int NECut, double ThetaBoostX, double ThetaBoostY, double TargetX, double TargetY, const char* FileName){
...
// TH1F *hSAcceptance = new TH1F("hSAcceptance", "hSAcceptance", 50, 0.5, 50.5);
TH1F *hFAcceptance = new TH1F("hFAcceptance", "hFAcceptance", 50, 0.5, 50.5);
// TH1F *hGAcceptance = new TH1F("hGAcceptance", "hGAcceptance", 20, 0.5, 20.5);
// hSAcceptance->SetMarkerStyle(20);
// hSAcceptance->SetMarkerColor(kRed);
// hSAcceptance->SetMarkerSize(2);
hFAcceptance->SetMarkerStyle(20);
hFAcceptance->SetMarkerColor(kGreen);
hFAcceptance->SetMarkerSize(2);
// hGAcceptance->SetMarkerStyle(20);
// hGAcceptance->SetMarkerColor(kBlue);
// hGAcceptance->SetMarkerSize(2);

// TH1F *hSNeve = new TH1F("hSNeve", "hSNumber of events in acceptance", 20, 0.5, 20.5);
TH1F *hFNeve = new TH1F("hFNeve", "hSNumber of events in acceptance", 50, 0.5, 50.5);
// TH1F *hGNeve = new TH1F("hGNeve", "hSNumber of events in acceptance", 20, 0.5, 20.5);
// TH1F *hAcceptance = new TH1F("hAcceptance", "hAcceptance", NECut, E0-EStep/2, EFin-EStep/2);
// hSNeve->SetMarkerStyle(20);
// hSNeve->SetMarkerColor(kRed);
// hSNeve->SetMarkerSize(2);
hFNeve->SetMarkerStyle(20);
hFNeve->SetMarkerColor(kGreen);
hFNeve->SetMarkerSize(2);
// hGNeve->SetMarkerStyle(20);
// hGNeve->SetMarkerColor(kBlue);
// hGNeve->SetMarkerSize(2);

int cut[8] = {1,2,5,7,10,15,20,50};
for(int iEb=0; iEb<8; iEb++){
    // EBeam = E0 + iEb*EStep;
    cout<<"Cut in energy of the "<<iEb<<" iteration: "<<cut[iEb]<<endl;
    ...
    // string Sline;
    ifstream FtxtIn(("/home/marco/analysis/SM_analysis/CalcHepFiles/BhabhaFull/BhabhaFull_280_Cut" + to_string(cut[iEb]) +"MeV.txt").c_str()); 
    string Fline;
    ...
    while (getline(FtxtIn, Fline)) { 
        if (Fline.find(searchString) != string::npos) { 
            ...
            if (regex_search(Fline, match, numberRegex)) {
                string numberString = match.str();
                mFCrossSection[cut[iEb]] = stod(numberString);
                mFInstantLumi[cut[iEb]] = stod(numberString) * Luminosity_C;
                // cout << "Numero trovato: " << stod(numberString) << endl;
                break; 
            }
        }
    ...
    FtxtIn.close(); 
    cout<<"la sezione d'urto letta dal file txt in input Full: "<<mFCrossSection[cut[iEb]]<<" pb al tagli in energia di: "<<cut[iEb]<<endl;
    ...
    TDirectory *Full_dir = FileOut->mkdir(("Full_dir"+ to_string(cut[iEb])).c_str());
    ...
    TFile *BhabhaFullIn = TFile::Open(("/home/marco/analysis/SM_analysis/CalcHepFiles/BhabhaFull/BhabhaFull_280_Cut" + to_string(static_cast<int>(cut[iEb])) +"MeV.root").c_str()); 
    // TFile *BhabhaFullIn  = new TFile("/home/marco/analysis/SM_analysis/CalcHepFiles/BhabhaFull.root");
    TTree *tFull  = (TTree*)BhabhaFullIn->Get(("tBhabhaFull_280_Cut" + to_string(cut[iEb]) +"MeV").c_str()); 
    ...
    TH1F* hInitialP3_pos = new TH1F(("hInitialP3_pos_" + to_string(cut[iEb])).c_str(), ("hInitialP3_pos_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hInitialP3_ele = new TH1F(("hInitialP3_ele_" + to_string(cut[iEb])).c_str(), ("hInitialP3_ele_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hFFinalP1_ele = new TH1F(("hFFinalP1_ele_" + to_string(cut[iEb])).c_str(), ("hFFinalP1_ele_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hFFinalP2_ele = new TH1F(("hFFinalP2_ele_" + to_string(cut[iEb])).c_str(), ("hFFinalP2_ele_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hFFinalP3_ele = new TH1F(("hFFinalP3_ele_" + to_string(cut[iEb])).c_str(), ("hFFinalP3_ele_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hFFinalP1_pos = new TH1F(("hFFinalP1_pos_" + to_string(cut[iEb])).c_str(), ("hFFinalP1_pos_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hFFinalP2_pos = new TH1F(("hFFinalP2_pos_" + to_string(cut[iEb])).c_str(), ("hFFinalP2_pos_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hFFinalP3_pos = new TH1F(("hFFinalP3_pos_" + to_string(cut[iEb])).c_str(), ("hFFinalP3_pos_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    ...
    TH1F* hInEnergy_pos = new TH1F(("hInEnergy_pos_" + to_string(cut[iEb])).c_str(), ("hInEnergy_pos_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hInEnergy_ele = new TH1F(("hInEnergy_ele_" + to_string(cut[iEb])).c_str(), ("hInEnergy_ele_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    ...
    TH1F* hFFinMomentum_pos = new TH1F(("hFFinMomentum_pos_" + to_string(cut[iEb])).c_str(), ("hFFinMomentum_pos_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    TH1F* hFFinMomentum_ele = new TH1F(("hFFinMomentum_ele_" + to_string(cut[iEb])).c_str(), ("hSFinMomentum_ele_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    ...
    TH1F* hFFinEnergy_pos = new TH1F(("hFFinEnergy_pos_" + to_string(cut[iEb])).c_str(), ("hFFinEnergy_pos_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);    
    TH1F* hFFinEnergy_ele = new TH1F(("hFFinEnergy_ele_" + to_string(cut[iEb])).c_str(), ("hFFinEnergy_ele_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    ...
    TH1F* hFullEn_tot = new TH1F(("hFullEn_tot_" + to_string(cut[iEb])).c_str(), ("hFullEn_tot_" + to_string(cut[iEb])).c_str(), Bin, -Range, Range);
    ...
    TH1F* hFPosTheta_Scattering = new TH1F(("hFPosTheta_Scattering_" + to_string(cut[iEb])).c_str(), ("hFPosTheta_Scattering_" + to_string(cut[iEb])).c_str(), 256*pi2, -pi2/4, pi2/4);
    TH1F* hFEleTheta_Scattering = new TH1F(("hFEleTheta_Scattering_" + to_string(cut[iEb])).c_str(), ("hFEleTheta_Scattering_" + to_string(cut[iEb])).c_str(), 256*pi2, -pi2/4, pi2/4);
    ...
    TH1F* hFPhiX_pos = new TH1F(("hFPhiX_pos_" + to_string(cut[iEb])).c_str(), ("hFPhiX_pos_" + to_string(cut[iEb])).c_str(), 256*pi2, -pi2/4, pi2/4);
    TH1F* hFPhiY_pos = new TH1F(("hFPhiY_pos_" + to_string(cut[iEb])).c_str(), ("hFPhiY_pos_" + to_string(cut[iEb])).c_str(), 256*pi2, -pi2/4, pi2/4);
    TH1F* hFPhiX_ele = new TH1F(("hFPhiX_ele_" + to_string(cut[iEb])).c_str(), ("hFPhiX_ele_" + to_string(cut[iEb])).c_str(), 256*pi2, -pi2/4, pi2/4);
    TH1F* hFPhiY_ele = new TH1F(("hFPhiY_ele_" + to_string(cut[iEb])).c_str(), ("hFPhiY_ele_" + to_string(cut[iEb])).c_str(), 256*pi2, -pi2/4, pi2/4);
    ...
    TH1F* hFx_pos = new TH1F(("hFx_pos_" + to_string(cut[iEb])).c_str(), ("hFx_pos_" + to_string(cut[iEb])).c_str(), 400, -1000, 1000);
    TH1F* hFy_pos = new TH1F(("hFy_pos_" + to_string(cut[iEb])).c_str(), ("hFy_pos_" + to_string(cut[iEb])).c_str(), 400, -1000, 1000);
    TH1F* hFx_ele = new TH1F(("hFx_ele_" + to_string(cut[iEb])).c_str(), ("hFx_ele_" + to_string(cut[iEb])).c_str(), 400, -1000, 1000);
    TH1F* hFy_ele = new TH1F(("hFy_ele_" + to_string(cut[iEb])).c_str(), ("hFy_ele_" + to_string(cut[iEb])).c_str(), 400, -1000, 1000);
    ...
    TH1F* hFRadius_pos = new TH1F(("hFRadius_pos_" + to_string(cut[iEb])).c_str(), ("hFRadius_pos_" + to_string(cut[iEb])).c_str(), 400, -1000, 1000);
    TH1F* hFRadius_ele = new TH1F(("hFRadius_ele_" + to_string(cut[iEb])).c_str(), ("hFRadius_ele_" + to_string(cut[iEb])).c_str(), 400, -1000, 1000);
    ...
    TH2F* hFOccupancy_pos = new TH2F(("hFOccupancy_pos_" + to_string(cut[iEb])).c_str(), ("hFOccupancy_pos_" + to_string(cut[iEb])).c_str(), res_occ, -450, 450, res_occ, -450, 450);
    TH2F* hFOccupancy_ele = new TH2F(("hFOccupancy_ele_" + to_string(cut[iEb])).c_str(), ("hFOccupancy_ele_" + to_string(cut[iEb])).c_str(), res_occ, -450, 450, res_occ, -450, 450);
    ...
    TH2F* hFOccupancyGeom_pos = new TH2F(("hFOccupancyGeom_pos_" + to_string(cut[iEb])).c_str(), ("hFOccupancyGeom_pos_" + to_string(cut[iEb])).c_str(), CaloRes, -300, 300, CaloRes, -300, 300);
    TH2F* hFOccupancyGeom_ele = new TH2F(("hFOccupancyGeom_ele_" + to_string(cut[iEb])).c_str(), ("hFOccupancyGeom_ele_" + to_string(cut[iEb])).c_str(), CaloRes, -300, 300, CaloRes, -300, 300);
    ...
    TH2F* hFOccupancyAllCuts_pos = new TH2F(("hFOccupancyAllCuts_pos_" + to_string(cut[iEb])).c_str(), ("hFOccupancyAllCuts_pos_" + to_string(cut[iEb])).c_str(), CaloRes, -300, 300, CaloRes, -300, 300);
    TH2F* hFOccupancyAllCuts_ele = new TH2F(("hFOccupancyAllCuts_ele_" + to_string(cut[iEb])).c_str(), ("hFOccupancyAllCuts_ele_" + to_string(cut[iEb])).c_str(), CaloRes, -300, 300, CaloRes, -300, 300);
    ...
    for(int it = 0; it<tFull->GetEntries(); it++){
        // tSch->GetEntry(it);
        tFull->GetEntry(it);
        // tGG->GetEntry(it);
        ...
        hFEleTheta_Scattering->Fill(Full_P4.ScatteringAngle());
    ...
    FNev_accepted = mFInstantLumi[cut[iEb]]*(hFOccupancyAllCuts_pos->GetEntries() / Nev_CalcHep);
    ...
    hFAcceptance->Fill(cut[iEb], hFOccupancyAllCuts_pos->GetEntries() / Nev_CalcHep);
    // hGAcceptance->Fill(EBeam, hGOccupancyAllCuts_G1->GetEntries() / Nev_CalcHep);
    // hSNeve->Fill(EBeam, SNev_accepted);
    hFNeve->Fill(cut[iEb], FNev_accepted);
