...
// void X17_backgroundNew(){ 
  ...
  TH2F *h15 = new TH2F("h15", "T-Channel positron R_{max} = 270 mm and E > 100 MeV", CaloRes, -300, 300, CaloRes, -300, 300);  //istogramma 2d con tagli geometrici e energetici
  TH2F *h16 = new TH2F("h16", "T-Channel electron R_{max} = 270 mm and E > 100 MeV ", CaloRes, -300, 300, CaloRes, -300, 300);

  TH2F *h17 = new TH2F("h17", "#gamma_{1} final position R_{max} = 270 mm", CaloRes, -300, 300, CaloRes, -300, 300);  //istogramma 2d per tutti gli eventi con soli tagli geometrici
  TH2F *h18 = new TH2F("h18", "#gamma_{2} final position R_{max} = 270 mm", CaloRes, -300, 300, CaloRes, -300, 300);

  TH2F *h19 = new TH2F("h19", "#gamma_{1} final position R_{max} = 270 mm and E > 100 MeV", CaloRes, -300, 300, CaloRes, -300, 300);  //istogramma 2d con tagli geometrici e energetici
  TH2F *h20 = new TH2F("h20", "#gamma_{2} final position R_{max} = 270 mm and E > 100 MeV", CaloRes, -300, 300, CaloRes, -300, 300);
  ...
  TH1F *HScut = new TH1F("HScut", "S-channel e^{+} R_{min} = 90 mm, R_{max} = 270 mm, E_{min} = 100 MeV", 60, 0, 300);
  TH1F *HTcut = new TH1F("HTcut", "T-channel e^{+} R_{min} = 90 mm, R_{max} = 270 mm, E_{min} = 100 MeV", 60, 0, 300);
  TH1F *HAcut = new TH1F("HAcut", "#gamma_{1} R_{min} = 90 mm, R_{max} = 270 mm, E_{min} = 100 MeV", 60, 0, 300);
  TH1F *HS1cut = new TH1F("HS1cut", "S-channel e^{-} R_{min} = 90 mm, R_{max} = 270 mm, E_{min} = 100 MeV", 60, 0, 300);
  TH1F *HT1cut = new TH1F("HT1cut", "T-channel e^{-} R_{min} = 90 mm, R_{max} = 270 mm, E_{min} = 100 MeV", 60, 0, 300);
  TH1F *HA1cut = new TH1F("HA1cut", "#gamma_{2} R_{min} = 90 mm, R_{max} = 270 mm, E_{min} = 100 MeV", 60, 0, 300);
  ...
  hg1->SetXTitle("y [mm]"); hg1->SetYTitle("x [mm]");
  hg2->SetXTitle("y [mm]"); hg2->SetYTitle("x [mm]");
  hg3->SetXTitle("y [mm]"); hg3->SetYTitle("x [mm]");
  hg4->SetXTitle("y [mm]"); hg4->SetYTitle("x [mm]");
